...
<head>
    ...
    <title>Tres Panchos</title>
     ...
     <!-- Scroll top-->
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_ES/sdk.js#xfbml=1&version=v11.0&appId=2151992984850324&autoLogAppEvents=1" nonce="xwTjnf8e"></script>
    
    
    <!-- Scroll top-->
    <a href="#" class="scrolltop" id="scroll-top">
        <i class="fa fa-chevron-up scrolltop__icon"></i>
    </a>
    ...
    <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="index.php" class="nav__logo">Los Tres Panchos</a>

                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item"><a href="promociones.php" class="nav__link active-link">Promociones</a></li>
